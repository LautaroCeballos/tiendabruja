...
export default function AddEditNav(){
    return <>
        ...
        >
            ...
            <Link to="/products/add"><Button leftIcon={<AddIcon/>} bg="brand.primary">Agregar</Button></Link>
            <Link to="/"><Button leftIcon={<RepeatIcon/>} bg="brand.primary">Actualizar</Button></Link>
